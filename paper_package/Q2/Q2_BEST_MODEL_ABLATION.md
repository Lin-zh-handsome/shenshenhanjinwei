...
- 六组完整表：`results/ablation_table.csv`。
- 各组 `metrics.json`、`train_history.csv`、clean/missing 预测和混淆矩阵：`results/ablation/R*/`。
- 最终 R3 的原始和紧凑附件 3 预测、紧凑验证结果：`results/ablation/R3_reconstruction/`。
